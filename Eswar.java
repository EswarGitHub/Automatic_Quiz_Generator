...
public class Eswar extends JFrame{
	...
	void welcome(){
		...
		login.setBounds(470, 292, 100, 40);
		login.setFont(login.getFont().deriveFont(20f));
		login.setToolTipText("Click to Login");
		loginpseu.setBounds(450, 352, 150, 40);
		loginpseu.setFont(login.getFont().deriveFont(20f));
		loginpseu.setToolTipText("Click to sign-up");
		add(loginpseu);
		loginpseu.addActionListener(
				new ActionListener() {
	...
	void check() {
		...
		u.pass = new String(password.getPassword());*/
		if(username.getText().equals("")) {
			JOptionPane.showMessageDialog(e, "Please enter username.","Alert!",JOptionPane.WARNING_MESSAGE);
		}
		else if(new String(password.getPassword()).equals("")) {
			JOptionPane.showMessageDialog(e, "Please enter password.","Alert!",JOptionPane.WARNING_MESSAGE);
		}
			...
			password.setText("");
			username.setText("");
			JOptionPane.showMessageDialog(e, "Wrong username or password.\nTry Again.","Warning!",JOptionPane.WARNING_MESSAGE);
		}
	}
	void enter(){
	...
	void pin(){
		...
		password.setBounds(460,232,200,30);
		password.setFont(password.getFont().deriveFont(20f));
		password.setToolTipText("Enter PIN here");
		login.setBounds(470, 292, 100, 40);
		login.setFont(login.getFont().deriveFont(20f));
		login.setToolTipText("Click to Login");
		password.addActionListener(
				new ActionListener() {
					public void actionPerformed(ActionEvent event) {
						if(new String(password.getPassword()).equals(""))
							JOptionPane.showMessageDialog(e, "Please enter PIN.","Alert!",JOptionPane.WARNING_MESSAGE);
						else if(new String(password.getPassword()).equals("1234"))
						{
							getContentPane().removeAll();
						getContentPane().repaint();
						welcome();
						validate();
							...
							JOptionPane.showMessageDialog(e, "You entered wrong PIN.","Alert!",JOptionPane.WARNING_MESSAGE);
							password.setText("");
						}
					}
				}
